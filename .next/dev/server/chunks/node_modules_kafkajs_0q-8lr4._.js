module.exports = [
"[project]/node_modules/kafkajs/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Kafka = __turbopack_context__.r("[project]/node_modules/kafkajs/src/index.js [app-route] (ecmascript)");
const PartitionAssigners = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assigners/index.js [app-route] (ecmascript)");
const AssignerProtocol = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assignerProtocol.js [app-route] (ecmascript)");
const Partitioners = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/index.js [app-route] (ecmascript)");
const Compression = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const ConfigResourceTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/configResourceTypes.js [app-route] (ecmascript)");
const ConfigSource = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/configSource.js [app-route] (ecmascript)");
const AclResourceTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclResourceTypes.js [app-route] (ecmascript)");
const AclOperationTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclOperationTypes.js [app-route] (ecmascript)");
const AclPermissionTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclPermissionTypes.js [app-route] (ecmascript)");
const ResourcePatternTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/resourcePatternTypes.js [app-route] (ecmascript)");
const { isRebalancing, isKafkaJSError, ...errors } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { LEVELS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/loggers/index.js [app-route] (ecmascript)");
module.exports = {
    Kafka,
    PartitionAssigners,
    AssignerProtocol,
...
"[project]/node_modules/kafkajs/package.json.[json].cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/admin/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const waitFor = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/waitFor.js [app-route] (ecmascript)");
const groupBy = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/groupBy.js [app-route] (ecmascript)");
const createConsumer = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/index.js [app-route] (ecmascript)");
const InstrumentationEventEmitter = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/emitter.js [app-route] (ecmascript)");
const { events, wrap: wrapEvent, unwrap: unwrapEvent } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/admin/instrumentationEvents.js [app-route] (ecmascript)");
const { LEVELS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/loggers/index.js [app-route] (ecmascript)");
const { KafkaJSNonRetriableError, KafkaJSDeleteGroupsError, KafkaJSBrokerNotFound, KafkaJSDeleteTopicRecordsError, KafkaJSAggregateError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { staleMetadata } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const CONFIG_RESOURCE_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/configResourceTypes.js [app-route] (ecmascript)");
const ACL_RESOURCE_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclResourceTypes.js [app-route] (ecmascript)");
const ACL_OPERATION_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclOperationTypes.js [app-route] (ecmascript)");
const ACL_PERMISSION_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/aclPermissionTypes.js [app-route] (ecmascript)");
const RESOURCE_PATTERN_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/resourcePatternTypes.js [app-route] (ecmascript)");
const { EARLIEST_OFFSET, LATEST_OFFSET } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)");
...
const indexByPartition = (array)=>array.reduce((obj, { partition, ...props })=>Object.assign(obj, {
            [partition]: {
                ...props
            }
        }), {});
 ...
 */ module.exports = ({ logger: rootLogger, instrumentationEmitter: rootInstrumentationEmitter, retry, cluster })=>{
   ...
   */ const describeConfigs = async ({ resources, includeSynonyms })=>{
        ...
        return retrier(async (bail, retryCount, retryTime)=>{
            try {
                ...
                const responseResources = responses.reduce((result, { resources })=>[
                        ...result,
                        ...resources
                    ], []);
                return {
   ...
   */ const describeCluster = async ()=>{
        const { brokers: nodes, clusterId, controllerId } = await cluster.metadata({
            topics: []
        });
   ...
   */ const describeGroups = async (groupIds)=>{
        ...
        const responses = await Promise.all(groupsByCoordinator.map(async ({ coordinator, groupIds })=>{
            const retrier = createRetry(retry);
            const { groups } = await retrier(()=>coordinator.describeGroups({
                    groupIds
                }));
            return groups;
        }));
   ...
   */ const deleteGroups = async (groupIds)=>{
        ...
        return retrier(async (bail, retryCount, retryTime)=>{
            try {
                ...
                const errors = res.flatMap(({ results })=>results.map(({ groupId, errorCode, error })=>{
                        return {
                            groupId,
                            errorCode,
                            error
   ...
   */ const deleteTopicRecords = async ({ topic, partitions })=>{
        ...
        return retrier(async (bail)=>{
            try {
                ...
                const brokerRequests = entries(seekEntriesByBroker).map(([nodeId, { topic, partitions }])=>async ()=>{
                        const broker = await cluster.findBroker({
                            nodeId
                        });
   ...
   */ const describeAcls = async ({ resourceType, resourceName, resourcePatternType, principal, host, operation, permissionType })=>{
        // Validate principal
...
"[project]/node_modules/kafkajs/src/admin/instrumentationEvents.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const swapObject = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/swapObject.js [app-route] (ecmascript)");
const networkEvents = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/instrumentationEvents.js [app-route] (ecmascript)");
const InstrumentationEventType = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/eventType.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/broker/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Lock = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/lock.js [app-route] (ecmascript)");
const { Types: Compression } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const { requests, lookup } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/index.js [app-route] (ecmascript)");
const { KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const apiKeys = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const shuffle = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/shuffle.js [app-route] (ecmascript)");
const PRIVATE = {
    SEND_REQUEST: Symbol('private:Broker:sendRequest')
};
/** @type {import("../protocol/requests").Lookup} */ const notInitializedLookup = ()=>{
 ...
 */ module.exports = class Broker {
   ...
   *                                                fetching metadata.
   */ constructor({ connectionPool, logger, nodeId = null, versions = null, authenticationTimeout = 10000, allowAutoTopicCreation = true }){
   ...
   * @returns {Promise}
   */ async produce({ topicData, transactionalId, producerId, producerEpoch, acks = -1, timeout = 30000, compression = Compression.None }) {
   ...
   * @returns {Promise}
   */ async fetch({ replicaId, isolationLevel, maxWaitTime = 5000, minBytes = 1, maxBytes = 10485760, topics, rackId = '' }) {
   ...
   * @returns {Promise}
   */ async joinGroup({ groupId, sessionTimeout, rebalanceTimeout, memberId = '', protocolType = 'consumer', groupProtocols }) {
   ...
   */ async alterPartitionReassignments({ topics, timeout }) {
        ...
        return await this[PRIVATE.SEND_REQUEST](alterPartitionReassignments({
            topics,
            timeout
        }));
    }
   ...
   */ async listPartitionReassignments({ topics = null, timeout }) {
        ...
        return await this[PRIVATE.SEND_REQUEST](listPartitionReassignments({
            topics,
            timeout
        }));
    }
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/awsIam.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { request, response } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/index.js [app-route] (ecmascript)");
const { KafkaJSSASLAuthenticationError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { requests, lookup } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/index.js [app-route] (ecmascript)");
const apiKeys = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const plainAuthenticatorProvider = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/plain.js [app-route] (ecmascript)");
const scram256AuthenticatorProvider = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram256.js [app-route] (ecmascript)");
const scram512AuthenticatorProvider = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram512.js [app-route] (ecmascript)");
const awsIAMAuthenticatorProvider = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/awsIam.js [app-route] (ecmascript)");
const oauthBearerAuthenticatorProvider = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/oauthBearer.js [app-route] (ecmascript)");
const { KafkaJSSASLAuthenticationError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/oauthBearer.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ const { request } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/index.js [app-route] (ecmascript)");
const { KafkaJSSASLAuthenticationError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
        ...
        return {
            authenticate: async ()=>{
                ...
                try {
                    ...
                    await saslAuthenticate({
                        request: await request(sasl, oauthBearerToken)
                    });
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/plain.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { request, response } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/plain/index.js [app-route] (ecmascript)");
const { KafkaJSSASLAuthenticationError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const crypto = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)");
const scram = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/index.js [app-route] (ecmascript)");
const { KafkaJSSASLAuthenticationError, KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const GS2_HEADER = 'n,,';
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram256.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { SCRAM, DIGESTS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/broker/saslAuthenticator/scram512.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/cluster/brokerPool.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Broker = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/index.js [app-route] (ecmascript)");
const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const shuffle = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/shuffle.js [app-route] (ecmascript)");
const arrayDiff = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/arrayDiff.js [app-route] (ecmascript)");
const { KafkaJSBrokerNotFound, KafkaJSProtocolError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { keys, assign, values } = Object;
const hasBrokerBeenReplaced = (broker, { host, port, rack })=>broker.connectionPool.host !== host || broker.connectionPool.port !== port || broker.connectionPool.rack !== rack;
module.exports = class BrokerPool {
   ...
   */ constructor({ connectionPoolBuilder, logger, retry, allowAutoTopicCreation, authenticationTimeout, metadataMaxAge }){
        this.rootLogger = logger;
...
"[project]/node_modules/kafkajs/src/cluster/connectionPoolBuilder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSConnectionError, KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const ConnectionPool = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/connectionPool.js [app-route] (ecmascript)");
/**
 ...
 */ module.exports = ({ socketFactory, brokers, ssl, sasl, clientId, requestTimeout, enforceRequestTimeout, connectionTimeout, maxInFlightRequests, logger, instrumentationEmitter = null, reauthenticationThreshold })=>{
    let index = 0;
...
"[project]/node_modules/kafkajs/src/cluster/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const BrokerPool = __turbopack_context__.r("[project]/node_modules/kafkajs/src/cluster/brokerPool.js [app-route] (ecmascript)");
const Lock = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/lock.js [app-route] (ecmascript)");
const sharedPromiseTo = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sharedPromiseTo.js [app-route] (ecmascript)");
const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const connectionPoolBuilder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/cluster/connectionPoolBuilder.js [app-route] (ecmascript)");
const { EARLIEST_OFFSET, LATEST_OFFSET } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)");
const { KafkaJSError, KafkaJSBrokerNotFound, KafkaJSMetadataNotLoaded, KafkaJSTopicMetadataNotLoaded, KafkaJSGroupCoordinatorNotFound } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const COORDINATOR_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/coordinatorTypes.js [app-route] (ecmascript)");
const { keys } = Object;
...
module.exports = class Cluster {
   ...
   */ constructor({ logger: rootLogger, socketFactory, brokers, ssl, sasl, clientId, connectionTimeout, authenticationTimeout, reauthenticationThreshold, requestTimeout = 30000, enforceRequestTimeout, metadataMaxAge, retry, allowAutoTopicCreation, maxInFlightRequests, isolationLevel, instrumentationEmitter = null, offsets = new Map() }){
...
"[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/consumer/assignerProtocol.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/consumer/assigners/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const roundRobin = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assigners/roundRobinAssigner/index.js [app-route] (ecmascript)");
module.exports = {
    roundRobin
};
}),
"[project]/node_modules/kafkajs/src/consumer/assigners/roundRobinAssigner/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { MemberMetadata, MemberAssignment } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assignerProtocol.js [app-route] (ecmascript)");
/**
 * RoundRobinAssigner
...
"[project]/node_modules/kafkajs/src/consumer/batch.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const filterAbortedMessages = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/filterAbortedMessages.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/consumer/consumerGroup.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const sleep = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sleep.js [app-route] (ecmascript)");
const websiteUrl = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/websiteUrl.js [app-route] (ecmascript)");
const arrayDiff = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/arrayDiff.js [app-route] (ecmascript)");
const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const sharedPromiseTo = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sharedPromiseTo.js [app-route] (ecmascript)");
const OffsetManager = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/offsetManager/index.js [app-route] (ecmascript)");
const Batch = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/batch.js [app-route] (ecmascript)");
const SeekOffsets = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/seekOffsets.js [app-route] (ecmascript)");
const SubscriptionState = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/subscriptionState.js [app-route] (ecmascript)");
const { events: { GROUP_JOIN, HEARTBEAT, CONNECT, RECEIVED_UNSUBSCRIBED_TOPICS } } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/instrumentationEvents.js [app-route] (ecmascript)");
const { MemberAssignment } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assignerProtocol.js [app-route] (ecmascript)");
const { KafkaJSError, KafkaJSNonRetriableError, KafkaJSStaleTopicMetadataAssignment, isRebalancing } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { keys } = Object;
...
module.exports = class ConsumerGroup {
   ...
   * @param {number} options.metadataMaxAge
   */ constructor({ retry, cluster, groupId, topics, topicConfigurations, logger, instrumentationEmitter, assigners, sessionTimeout, rebalanceTimeout, maxBytesPerPartition, minBytes, maxBytes, maxWaitTimeInMs, autoCommit, autoCommitInterval, autoCommitThreshold, isolationLevel, rackId, metadataMaxAge }){
   ...
   */ isPaused(topic, partition) {
    ...
    async heartbeat({ interval }) {
        return this[PRIVATE.SHARED_HEARTBEAT]({
            interval
        });
    }
    async fetch(nodeId) {
        try {
            ...
            return responses.flatMap(({ topicName, partitions })=>{
                ...
                return partitions.filter(({ partition })=>!this.seekOffset.has(topicName, partition) && !this.subscriptionState.isPaused(topicName, partition)).map((partitionData)=>{
                    ...
                    const partitionRequestData = topicRequestData.partitions.find(({ partition })=>partition === partitionData.partition);
...
"[project]/node_modules/kafkajs/src/consumer/fetchManager.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const seq = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/seq.js [app-route] (ecmascript)");
const createFetcher = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/fetcher.js [app-route] (ecmascript)");
const createWorker = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/worker.js [app-route] (ecmascript)");
const createWorkerQueue = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/workerQueue.js [app-route] (ecmascript)");
const { KafkaJSFetcherRebalanceError, KafkaJSNoBrokerAvailableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
 ...
 * @template T
 */ const createFetchManager = ({ logger: rootLogger, getNodeIds, fetch, handler, concurrency = 1 })=>{
...
"[project]/node_modules/kafkajs/src/consumer/fetcher.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 * @param {import('../../types').Logger} options.logger
 * @template T
 */ const createFetcher = ({ nodeId, workerQueue, partitionAssignments, fetch, logger: rootLogger })=>{
...
"[project]/node_modules/kafkajs/src/consumer/filterAbortedMessages.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const ABORTED_MESSAGE_KEY = Buffer.from([
    0,
    0,
    0,
    0
...
"[project]/node_modules/kafkajs/src/consumer/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const { initialRetryTime } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/defaults.js [app-route] (ecmascript)");
const ConsumerGroup = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/consumerGroup.js [app-route] (ecmascript)");
const Runner = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/runner.js [app-route] (ecmascript)");
const { events, wrap: wrapEvent, unwrap: unwrapEvent } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/instrumentationEvents.js [app-route] (ecmascript)");
const InstrumentationEventEmitter = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/emitter.js [app-route] (ecmascript)");
const { KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { roundRobin } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/assigners/index.js [app-route] (ecmascript)");
const { EARLIEST_OFFSET, LATEST_OFFSET } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)");
const ISOLATION_LEVEL = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)");
const sharedPromiseTo = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sharedPromiseTo.js [app-route] (ecmascript)");
 ...
 */ module.exports = ({ cluster, groupId, retry, logger: rootLogger, partitionAssigners = [
    roundRobin
], sessionTimeout = 30000, rebalanceTimeout = 60000, heartbeatInterval = 3000, maxBytesPerPartition = 1048576, minBytes = 1, maxBytes = 10485760, maxWaitTimeInMs = 5000, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, rackId = '', instrumentationEmitter: rootInstrumentationEmitter, metadataMaxAge })=>{
    if (!groupId) {
    ...
    /** @type {import("../../types").Consumer["stop"]} */ const stop = sharedPromiseTo(async ()=>{
        try {
            if (runner) {
                await runner.stop();
                runner = null;
    ...
    /** @type {import("../../types").Consumer["subscribe"]} */ const subscribe = async ({ topic, topics: subscriptionTopics, fromBeginning = false })=>{
        if (consumerGroup) {
    ...
    /** @type {import("../../types").Consumer["run"]} */ const run = async ({ autoCommit = true, autoCommitInterval = null, autoCommitThreshold = null, eachBatchAutoResolve = true, partitionsConsumedConcurrently: concurrency = 1, eachBatch = null, eachMessage = null } = {})=>{
        if (consumerGroup) {
   ...
   */ const commitOffsets = async (topicPartitions = [])=>{
    ...
    /** @type {import("../../types").Consumer["seek"]} */ const seek = ({ topic, partition, offset })=>{
        if (!topic) {
            throw new KafkaJSNonRetriableError(`Invalid topic ${topic}`);
        }
        if (isNaN(partition)) {
...
"[project]/node_modules/kafkajs/src/consumer/instrumentationEvents.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const swapObject = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/swapObject.js [app-route] (ecmascript)");
const InstrumentationEventType = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/eventType.js [app-route] (ecmascript)");
const networkEvents = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/instrumentationEvents.js [app-route] (ecmascript)");
const consumerType = InstrumentationEventType('consumer');
/** @type {import('types').ConsumerEvents} */ const events = {
...
"[project]/node_modules/kafkajs/src/consumer/offsetManager/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const isInvalidOffset = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/offsetManager/isInvalidOffset.js [app-route] (ecmascript)");
const initializeConsumerOffsets = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/offsetManager/initializeConsumerOffsets.js [app-route] (ecmascript)");
const { events: { COMMIT_OFFSETS } } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/instrumentationEvents.js [app-route] (ecmascript)");
...
module.exports = class OffsetManager {
   ...
   */ constructor({ cluster, coordinator, memberAssignment, autoCommit, autoCommitInterval, autoCommitThreshold, topicConfigurations, instrumentationEmitter, groupId, generationId, memberId }){
   ...
   */ uncommittedOffsets() {
    ...
    async commitOffsets(offsets = {}) {
        ...
        try {
            ...
            topics.forEach(({ topic, partitions })=>{
                const updatedOffsets = partitions.reduce((obj, { partition, offset })=>assign(obj, {
                        [partition]: offset
                    }), {});
    ...
    async resolveOffsets() {
        ...
        const unresolvedPartitions = consumerOffsets.map(({ topic, partitions })=>assign({
                topic,
                partitions: partitions.filter(({ offset })=>isInvalidOffset(offset)).map(({ partition })=>assign({
                        partition
                    }))
...
"[project]/node_modules/kafkajs/src/consumer/offsetManager/initializeConsumerOffsets.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const isInvalidOffset = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/offsetManager/isInvalidOffset.js [app-route] (ecmascript)");
const { keys, assign } = Object;
const indexPartitions = (obj, { partition, offset })=>assign(obj, {
        [partition]: offset
    });
const indexTopics = (obj, { topic, partitions })=>assign(obj, {
...
"[project]/node_modules/kafkajs/src/consumer/offsetManager/isInvalidOffset.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
module.exports = (offset)=>!offset && offset !== 0 || Long.fromValue(offset).isNegative();
}),
"[project]/node_modules/kafkajs/src/consumer/runner.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { EventEmitter } = __turbopack_context__.r("[externals]/events [external] (events, cjs)");
const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const { isKafkaJSError, isRebalancing } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { events: { FETCH, FETCH_START, START_BATCH_PROCESS, END_BATCH_PROCESS, REBALANCING } } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/instrumentationEvents.js [app-route] (ecmascript)");
const createFetchManager = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/fetchManager.js [app-route] (ecmascript)");
...
module.exports = class Runner extends EventEmitter {
   ...
   */ constructor({ logger, consumerGroup, instrumentationEmitter, eachBatchAutoResolve = true, concurrency, eachBatch, eachMessage, heartbeatInterval, onCrash, retry, autoCommit = true }){
        super();
...
"[project]/node_modules/kafkajs/src/consumer/seekOffsets.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/consumer/subscriptionState.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/consumer/worker.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/consumer/workerQueue.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/env.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const pkgJson = __turbopack_context__.r("[project]/node_modules/kafkajs/package.json.[json].cjs [app-route] (ecmascript)");
const { bugs } = pkgJson;
...
"[project]/node_modules/kafkajs/src/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { createLogger, LEVELS: { INFO } } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/loggers/index.js [app-route] (ecmascript)");
const InstrumentationEventEmitter = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/emitter.js [app-route] (ecmascript)");
const LoggerConsole = __turbopack_context__.r("[project]/node_modules/kafkajs/src/loggers/console.js [app-route] (ecmascript)");
const Cluster = __turbopack_context__.r("[project]/node_modules/kafkajs/src/cluster/index.js [app-route] (ecmascript)");
const createProducer = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/index.js [app-route] (ecmascript)");
const createConsumer = __turbopack_context__.r("[project]/node_modules/kafkajs/src/consumer/index.js [app-route] (ecmascript)");
const createAdmin = __turbopack_context__.r("[project]/node_modules/kafkajs/src/admin/index.js [app-route] (ecmascript)");
const ISOLATION_LEVEL = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)");
const defaultSocketFactory = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/socketFactory.js [app-route] (ecmascript)");
const once = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/once.js [app-route] (ecmascript)");
const websiteUrl = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/websiteUrl.js [app-route] (ecmascript)");
const PRIVATE = {
...
module.exports = class Client {
   ...
   * @param {import("../types").RetryOptions} [options.retry]
   * @param {import("../types").ISocketFactory} [options.socketFactory]
   */ constructor({ brokers, ssl, sasl, clientId, connectionTimeout = 1000, authenticationTimeout, reauthenticationThreshold, requestTimeout, enforceRequestTimeout = true, retry, socketFactory = defaultSocketFactory(), logLevel = INFO, logCreator = LoggerConsole }){
        ...
        this[PRIVATE.CREATE_CLUSTER] = ({ metadataMaxAge, allowAutoTopicCreation = true, maxInFlightRequests = null, instrumentationEmitter = null, isolationLevel })=>new Cluster({
    ...
    /**
   * @public
   */ producer({ createPartitioner, retry, metadataMaxAge = DEFAULT_METADATA_MAX_AGE, allowAutoTopicCreation, idempotent, transactionalId, transactionTimeout, maxInFlightRequests } = {}) {
    ...
    /**
   * @public
   */ consumer({ groupId, partitionAssigners, metadataMaxAge = DEFAULT_METADATA_MAX_AGE, sessionTimeout, rebalanceTimeout, heartbeatInterval, maxBytesPerPartition, minBytes, maxBytes, maxWaitTimeInMs, retry = {
        retries: 5
    }, allowAutoTopicCreation, maxInFlightRequests, readUncommitted = false, rackId = '' } = {}) {
...
"[project]/node_modules/kafkajs/src/instrumentation/emitter.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { EventEmitter } = __turbopack_context__.r("[externals]/events [external] (events, cjs)");
const InstrumentationEvent = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/event.js [app-route] (ecmascript)");
const { KafkaJSError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/instrumentation/event.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/instrumentation/eventType.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/** @type {<T1 extends string>(namespace: T1) => <T2 extends string>(type: T2) => `${T1}.${T2}`} */ module.exports = (namespace)=>(type)=>`${namespace}.${type}`;
}),
"[project]/node_modules/kafkajs/src/loggers/console.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { LEVELS: logLevel } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/loggers/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/loggers/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/network/connection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const createSocket = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/socket.js [app-route] (ecmascript)");
const createRequest = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/request.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { KafkaJSConnectionError, KafkaJSConnectionClosedError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { INT_32_MAX_VALUE } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)");
const getEnv = __turbopack_context__.r("[project]/node_modules/kafkajs/src/env.js [app-route] (ecmascript)");
const RequestQueue = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/requestQueue/index.js [app-route] (ecmascript)");
const { CONNECTION_STATUS, CONNECTED_STATUS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/connectionStatus.js [app-route] (ecmascript)");
const sharedPromiseTo = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sharedPromiseTo.js [app-route] (ecmascript)");
const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const SASLAuthenticator = __turbopack_context__.r("[project]/node_modules/kafkajs/src/broker/saslAuthenticator/index.js [app-route] (ecmascript)");
const apiKeys = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const requestInfo = ({ apiName, apiKey, apiVersion })=>`${apiName}(key: ${apiKey}, version: ${apiVersion})`;
/**
...
module.exports = class Connection {
   ...
   *                                            enqueuing
   * @param {import("../instrumentation/emitter")} [options.instrumentationEmitter=null]
   */ constructor({ host, port, logger, socketFactory, requestTimeout, reauthenticationThreshold = 10000, rack = null, ssl = null, sasl = null, clientId = 'kafkajs', connectionTimeout, enforceRequestTimeout = true, maxInFlightRequests = null, instrumentationEmitter = null }){
        this.host = host;
        this.port = port;
        this.rack = rack;
...
"[project]/node_modules/kafkajs/src/network/connectionPool.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const apiKeys = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const Connection = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/connection.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/network/connectionStatus.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/network/instrumentationEvents.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/network/requestQueue/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { EventEmitter } = __turbopack_context__.r("[externals]/events [external] (events, cjs)");
const SocketRequest = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/requestQueue/socketRequest.js [app-route] (ecmascript)");
const events = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/instrumentationEvents.js [app-route] (ecmascript)");
const { KafkaJSInvariantViolation } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const PRIVATE = {
...
module.exports = class RequestQueue extends EventEmitter {
   ...
   */ constructor({ instrumentationEmitter = null, maxInFlightRequests, requestTimeout, enforceRequestTimeout, clientId, broker, logger, isConnected = ()=>true }){
        super();
        this.instrumentationEmitter = instrumentationEmitter;
...
"[project]/node_modules/kafkajs/src/network/requestQueue/socketRequest.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSRequestTimeoutError, KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const events = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/instrumentationEvents.js [app-route] (ecmascript)");
const PRIVATE = {
 ...
 */ module.exports = class SocketRequest {
   ...
   * @param {import("../../instrumentation/emitter")} [options.instrumentationEmitter=null]
   */ constructor({ requestTimeout, broker, clientId, entry, expectResponse, send, timeout, instrumentationEmitter = null }){
...
"[project]/node_modules/kafkajs/src/network/socket.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ module.exports = ({ socketFactory, host, port, ssl, onConnect, onData, onEnd, onError, onTimeout })=>{
...
"[project]/node_modules/kafkajs/src/network/socketFactory.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/createTopicData.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/eosManager/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const Lock = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/lock.js [app-route] (ecmascript)");
const { KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const COORDINATOR_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/coordinatorTypes.js [app-route] (ecmascript)");
const createStateMachine = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/eosManager/transactionStateMachine.js [app-route] (ecmascript)");
const { INT_32_MAX_VALUE } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/constants.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/assert [external] (assert, cjs)");
const STATES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/eosManager/transactionStates.js [app-route] (ecmascript)");
 ...
 *
 * @returns {EosManager}
 */ module.exports = ({ logger, cluster, transactionTimeout = 60000, transactional, transactionalId })=>{
...
"[project]/node_modules/kafkajs/src/producer/eosManager/transactionStateMachine.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/eosManager/transactionStates.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/groupMessagesPerPartition.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const createRetry = __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)");
const { CONNECTION_STATUS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/connectionStatus.js [app-route] (ecmascript)");
const { DefaultPartitioner } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/index.js [app-route] (ecmascript)");
const InstrumentationEventEmitter = __turbopack_context__.r("[project]/node_modules/kafkajs/src/instrumentation/emitter.js [app-route] (ecmascript)");
const createEosManager = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/eosManager/index.js [app-route] (ecmascript)");
const createMessageProducer = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/messageProducer.js [app-route] (ecmascript)");
const { events, wrap: wrapEvent, unwrap: unwrapEvent } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/instrumentationEvents.js [app-route] (ecmascript)");
const { KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
 ...
 */ module.exports = ({ cluster, logger: rootLogger, createPartitioner = DefaultPartitioner, retry, idempotent = false, transactionalId, transactionTimeout, instrumentationEmitter: rootInstrumentationEmitter })=>{
...
"[project]/node_modules/kafkajs/src/producer/instrumentationEvents.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/messageProducer.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const createSendMessages = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/sendMessages.js [app-route] (ecmascript)");
const { KafkaJSError, KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { CONNECTION_STATUS } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/network/connectionStatus.js [app-route] (ecmascript)");
module.exports = ({ logger, cluster, partitioner, eosManager, idempotent, retrier, getConnectionStatus })=>{
...
"[project]/node_modules/kafkajs/src/producer/partitioners/default/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const murmur2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/default/murmur2.js [app-route] (ecmascript)");
const createDefaultPartitioner = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/legacy/partitioner.js [app-route] (ecmascript)");
module.exports = createDefaultPartitioner(murmur2);
}),
"[project]/node_modules/kafkajs/src/producer/partitioners/default/murmur2.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/* eslint-disable */ const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/producer/partitioners/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const DefaultPartitioner = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/default/index.js [app-route] (ecmascript)");
const LegacyPartitioner = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/legacy/index.js [app-route] (ecmascript)");
module.exports = {
    DefaultPartitioner,
    LegacyPartitioner,
    /**
...
"[project]/node_modules/kafkajs/src/producer/partitioners/legacy/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const murmur2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/legacy/murmur2.js [app-route] (ecmascript)");
const createLegacyPartitioner = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/legacy/partitioner.js [app-route] (ecmascript)");
module.exports = createLegacyPartitioner(murmur2);
}),
"[project]/node_modules/kafkajs/src/producer/partitioners/legacy/murmur2.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/producer/partitioners/legacy/partitioner.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const randomBytes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/partitioners/legacy/randomBytes.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/producer/partitioners/legacy/randomBytes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
if (/*TURBOPACK member replacement*/ __turbopack_context__.g && /*TURBOPACK member replacement*/ __turbopack_context__.g.crypto) {
    cryptoImplementation = /*TURBOPACK member replacement*/ __turbopack_context__.g.crypto.randomBytes === undefined ? toNodeCompatible(/*TURBOPACK member replacement*/ __turbopack_context__.g.crypto) : /*TURBOPACK member replacement*/ __turbopack_context__.g.crypto;
} else if (/*TURBOPACK member replacement*/ __turbopack_context__.g && /*TURBOPACK member replacement*/ __turbopack_context__.g.msCrypto) {
    cryptoImplementation = toNodeCompatible(/*TURBOPACK member replacement*/ __turbopack_context__.g.msCrypto);
} else if (/*TURBOPACK member replacement*/ __turbopack_context__.g && !/*TURBOPACK member replacement*/ __turbopack_context__.g.crypto) {
    cryptoImplementation = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)");
}
...
"[project]/node_modules/kafkajs/src/producer/responseSerializer.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = ({ topics })=>topics.flatMap(({ topicName, partitions })=>partitions.map((partition)=>({
                topicName,
                ...partition
            })));
}),
"[project]/node_modules/kafkajs/src/producer/sendMessages.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSMetadataNotLoaded } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { staleMetadata } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const groupMessagesPerPartition = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/groupMessagesPerPartition.js [app-route] (ecmascript)");
const createTopicData = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/createTopicData.js [app-route] (ecmascript)");
const responseSerializer = __turbopack_context__.r("[project]/node_modules/kafkajs/src/producer/responseSerializer.js [app-route] (ecmascript)");
const { keys } = Object;
/**
 * @param {Object} options
 * @param {import("../../types").Logger} options.logger
...
"[project]/node_modules/kafkajs/src/protocol/aclOperationTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/aclPermissionTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/aclResourceTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/configResourceTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/configSource.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/coordinatorTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/crc32.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSInvalidVarIntError, KafkaJSInvalidLongError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const INT8_SIZE = 1;
const INT16_SIZE = 2;
const INT32_SIZE = 4;
...
"[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSProtocolError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const websiteUrl = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/websiteUrl.js [app-route] (ecmascript)");
const errorCodes = [
    {
        type: 'UNKNOWN',
...
"[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/message/compression/gzip.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSNotImplemented } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
const Codecs = {
    [Types.GZIP]: ()=>__turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/gzip.js [app-route] (ecmascript)"),
    [Types.Snappy]: ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/message/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSPartialMessageError, KafkaJSUnsupportedMagicByteInMessageSet } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const V0Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/v0/decoder.js [app-route] (ecmascript)");
const V1Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/v1/decoder.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/message/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/v0/index.js [app-route] (ecmascript)"),
    1: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/v1/index.js [app-route] (ecmascript)")
};
module.exports = ({ version = 0 })=>versions[version];
}),
"[project]/node_modules/kafkajs/src/protocol/message/v0/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/message/v0/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const crc32 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/crc32.js [app-route] (ecmascript)");
const { Types: Compression, COMPRESSION_CODEC_MASK } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
/**
 * v0
...
"[project]/node_modules/kafkajs/src/protocol/message/v1/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/message/v1/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/messageSet/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const MessageDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/decoder.js [app-route] (ecmascript)");
const { lookupCodecByAttributes } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const { KafkaJSPartialMessageError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/messageSet/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const MessageProtocol = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/index.js [app-route] (ecmascript)");
const { Types } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
/**
 * MessageSet => [Offset MessageSize Message]
 *  Offset => int64
 *  MessageSize => int32
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/crc32C/crc32C.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/crc32C/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const crc32C = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/crc32C/crc32C.js [app-route] (ecmascript)");
const unsigned = (value)=>Uint32Array.from([
        value
    ])[0];
module.exports = (buffer)=>unsigned(crc32C(buffer));
}),
"[project]/node_modules/kafkajs/src/protocol/recordBatch/header/v0/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/header/v0/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/record/v0/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const HeaderDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/header/v0/decoder.js [app-route] (ecmascript)");
const TimestampTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/timestampTypes.js [app-route] (ecmascript)");
/**
 * v0
 * Record =>
 *   Length => Varint
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/record/v0/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const Header = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/header/v0/index.js [app-route] (ecmascript)");
/**
 * v0
 * Record =>
 *   Length => Varint
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/v0/decoder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { KafkaJSPartialMessageError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { lookupCodecByAttributes } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const RecordDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/record/v0/decoder.js [app-route] (ecmascript)");
const TimestampTypes = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/timestampTypes.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/recordBatch/v0/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const crc32C = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/crc32C/index.js [app-route] (ecmascript)");
const { Types: Compression, lookupCodec, COMPRESSION_CODEC_MASK } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const MAGIC_BYTE = 2;
 ...
 *  FirstSequence => int32
 *  Records => [Record]
 */ const RecordBatch = async ({ compression = Compression.None, firstOffset = Long.fromInt(0), firstTimestamp = Date.now(), maxTimestamp = Date.now(), partitionLeaderEpoch = 0, lastOffsetDelta = 0, transactional = false, producerId = Long.fromValue(-1), producerEpoch = 0, firstSequence = 0, records = [] })=>{
...
"[project]/node_modules/kafkajs/src/protocol/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ transactionalId, producerId, producerEpoch, groupId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
    ...
    1: ({ transactionalId, producerId, producerEpoch, groupId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { AddOffsetsToTxn: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failure, createErrorFromCode, failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/request.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ transactionalId, producerId, producerEpoch, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
    ...
    1: ({ transactionalId, producerId, producerEpoch, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { AddPartitionsToTxn: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failure, createErrorFromCode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/request.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ resources, validateOnly })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resources,
                validateOnly
    ...
    1: ({ resources, validateOnly })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resources,
                validateOnly
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { AlterConfigs: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/request.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { AlterPartitionReassignments: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSAggregateError, KafkaJSAlterPartitionReassignmentsError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failure, createErrorFromCode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const logResponseError = false;
const versions = {
    0: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response,
    ...
    1: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v1/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response,
            logResponseError
    ...
    2: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v2/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response,
            logResponseError
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { ApiVersions: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/request.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/v1/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/createAcls/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ creations })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                creations
            }),
    ...
    1: ({ creations })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                creations
            }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { CreateAcls: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
 ...
 */ const encodeCreations = ({ resourceType, resourceName, principal, host, operation, permissionType })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     operation => INT8
 *     permission_type => INT8
 */ const encodeCreations = ({ resourceType, resourceName, resourcePatternType, principal, host, operation, permissionType })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topicPartitions, timeout, validateOnly })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topicPartitions,
                timeout,
    ...
    1: ({ topicPartitions, validateOnly, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topicPartitions,
                validateOnly,
...
"[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { CreatePartitions: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/request.js [app-route] (ecmascript)");
/**
 ...
 *   timeout => INT32
 *   validate_only => BOOLEAN
 */ module.exports = ({ topicPartitions, validateOnly, timeout })=>Object.assign(requestV0({
        topicPartitions,
        validateOnly,
        timeout
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
    ...
    1: ({ topics, validateOnly, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                validateOnly,
    ...
    2: ({ topics, validateOnly, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                validateOnly,
    ...
    3: ({ topics, validateOnly, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                validateOnly,
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { CreateTopics: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
const encodeTopics = ({ topic, numPartitions = -1, replicationFactor = -1, replicaAssignment = [], configEntries = [] })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failure, createErrorFromCode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { KafkaJSAggregateError, KafkaJSCreateTopicError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/request.js [app-route] (ecmascript)");
/**
 ...
 *   timeout => INT32
 *   validate_only => BOOLEAN
 */ module.exports = ({ topics, validateOnly, timeout })=>Object.assign(requestV1({
        topics,
        validateOnly,
        timeout
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v1/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/request.js [app-route] (ecmascript)");
/**
 ...
 *   timeout => INT32
 *   validate_only => BOOLEAN
 */ module.exports = ({ topics, validateOnly, timeout })=>Object.assign(requestV2({
        topics,
        validateOnly,
        timeout
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV2 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ filters })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                filters
            }),
    ...
    1: ({ filters })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                filters
            }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DeleteAcls: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
 ...
 *     operation => INT8
 *     permission_type => INT8
 */ const encodeFilters = ({ resourceType, resourceName, principal, host, operation, permissionType })=>{
    return new Encoder().writeInt8(resourceType).writeString(resourceName).writeString(principal).writeString(host).writeInt8(operation).writeInt8(permissionType);
};
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     operation => INT8
 *     permission_type => INT8
 */ const encodeFilters = ({ resourceType, resourceName, resourcePatternType, principal, host, operation, permissionType })=>{
    return new Encoder().writeInt8(resourceType).writeString(resourceName).writeInt8(resourcePatternType).writeString(principal).writeString(host).writeInt8(operation).writeInt8(permissionType);
};
module.exports = ({ filters })=>({
        apiKey,
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: (groupIds)=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/response.js [app-route] (ecmascript)");
        return {
    ...
    1: (groupIds)=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v1/response.js [app-route] (ecmascript)");
        return {
            request: request(groupIds),
            response
        };
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DeleteGroups: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/request.js [app-route] (ecmascript)");
/**
 * DeleteGroups Request (Version: 1)
 */ module.exports = (groupIds)=>Object.assign(requestV0(groupIds), {
        apiVersion: 1
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
    ...
    1: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DeleteRecords: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { KafkaJSDeleteTopicRecordsError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { failure, createErrorFromCode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/request.js [app-route] (ecmascript)");
/**
 ...
 *       offset => INT64
 *   timeout => INT32
 */ module.exports = ({ topics, timeout })=>Object.assign(requestV0({
        topics,
        timeout
    }), {
        apiVersion: 1
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const responseV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
 ...
 *      error_code => INT16
 */ module.exports = ({ topics })=>{
    const { parse, decode: decodeV0 } = responseV0({
        topics
    });
    const decode = async (rawData)=>{
        const decoded = await decodeV0(rawData);
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
    ...
    1: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DeleteTopics: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/request.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ resourceType, resourceName, principal, host, operation, permissionType })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resourceType,
                resourceName,
    ...
    1: ({ resourceType, resourceName, resourcePatternType, principal, host, operation, permissionType })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resourceType,
                resourceName,
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DescribeAcls: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *   operation => INT8
 *   permission_type => INT8
 */ module.exports = ({ resourceType, resourceName, resourcePatternType, principal, host, operation, permissionType })=>({
        apiKey,
        apiVersion: 1,
        apiName: 'DescribeAcls',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/v0/response.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ resources })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resources
            }),
    ...
    1: ({ resources, includeSynonyms })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resources,
                includeSynonyms
    ...
    2: ({ resources, includeSynonyms })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                resources,
                includeSynonyms
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DescribeConfigs: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v0/response.js [app-route] (ecmascript)");
const { DEFAULT_CONFIG } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/configSource.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/request.js [app-route] (ecmascript)");
/**
 * DescribeConfigs Request (Version: 1) => [resources] include_synonyms
 *   resources => resource_type resource_name [config_names]
 *     resource_type => INT8
 ...
 * @param {Array} resources An array of config resources to be returned
 * @param [includeSynonyms=false]
 */ module.exports = ({ resources, includeSynonyms })=>Object.assign(requestV1({
        resources,
        includeSynonyms
    }), {
        apiVersion: 2
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/v1/response.js [app-route] (ecmascript)");
/**
 * Starting in version 2, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ groupIds })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupIds
            }),
    ...
    1: ({ groupIds })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupIds
            }),
    ...
    2: ({ groupIds })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupIds
            }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { DescribeGroups: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/request.js [app-route] (ecmascript)");
/**
 * DescribeGroups Request (Version: 1) => [group_ids]
 *   group_ids => STRING
 */ module.exports = ({ groupIds })=>Object.assign(requestV0({
        groupIds
    }), {
        apiVersion: 1
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/request.js [app-route] (ecmascript)");
/**
 * DescribeGroups Request (Version: 2) => [group_ids]
 *   group_ids => STRING
 */ module.exports = ({ groupIds })=>Object.assign(requestV1({
        groupIds
    }), {
        apiVersion: 2
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/v1/response.js [app-route] (ecmascript)");
/**
 * Starting in version 2, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/endTxn/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ transactionalId, producerId, producerEpoch, transactionResult })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
    ...
    1: ({ transactionalId, producerId, producerEpoch, transactionResult })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { EndTxn: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/request.js [app-route] (ecmascript)");
/**
 ...
 *   producer_epoch => INT16
 *   transaction_result => BOOLEAN
 */ module.exports = ({ transactionalId, producerId, producerEpoch, transactionResult })=>Object.assign(requestV0({
        transactionalId,
        producerId,
        producerEpoch,
        transactionResult
...
"[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const versions = {
    0: ({ replicaId = REPLICA_ID, maxWaitTime, minBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                maxWaitTime,
    ...
    1: ({ replicaId = REPLICA_ID, maxWaitTime, minBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                maxWaitTime,
    ...
    2: ({ replicaId = REPLICA_ID, maxWaitTime, minBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                maxWaitTime,
    ...
    3: ({ replicaId = REPLICA_ID, maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                maxWaitTime,
    ...
    4: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    5: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    6: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v6/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v6/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    7: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [], maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v7/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v7/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    8: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [], maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v8/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v8/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    9: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [], maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    10: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [], maxWaitTime, minBytes, maxBytes, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v10/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v10/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    11: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [], maxWaitTime, minBytes, maxBytes, topics, rackId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v11/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v11/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Fetch: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { KafkaJSOffsetOutOfRange } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { failure, createErrorFromCode, errorCodes } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const MessageSetDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/messageSet/decoder.js [app-route] (ecmascript)");
/**
...
const { code: OFFSET_OUT_OF_RANGE_ERROR_CODE } = errorCodes.find((e)=>e.type === 'OFFSET_OUT_OF_RANGE');
const parse = async (data)=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/request.js [app-route] (ecmascript)");
module.exports = ({ replicaId, maxWaitTime, minBytes, topics })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v0/response.js [app-route] (ecmascript)");
const MessageSetDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/messageSet/decoder.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v10/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const ISOLATION_LEVEL = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)");
const requestV9 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/request.js [app-route] (ecmascript)");
/**
 * ZStd Compression
 ...
 *     topic => STRING
 *     partitions => INT32
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [] })=>Object.assign(requestV9({
        replicaId,
        maxWaitTime,
        minBytes,
        maxBytes,
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v10/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v11/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     partitions => INT32
 *   rack_id => STRING
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, rackId = '', isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [] })=>({
        apiKey,
        apiVersion: 11,
        apiName: 'Fetch',
        encode: async ()=>{
...
const encodePartition = ({ partition, currentLeaderEpoch = -1, fetchOffset, logStartOffset = -1, maxBytes })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v11/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/response.js [app-route] (ecmascript)");
const decodeMessages = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/decodeMessages.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v1/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/decodeMessages.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const MessageSetDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/messageSet/decoder.js [app-route] (ecmascript)");
const RecordBatchDecoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/v0/decoder.js [app-route] (ecmascript)");
const { MAGIC_BYTE } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/v0/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *       fetch_offset => INT64
 *       max_bytes => INT32
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED })=>({
        apiKey,
        apiVersion: 4,
        apiName: 'Fetch',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v6/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const ISOLATION_LEVEL = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)");
const requestV5 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/request.js [app-route] (ecmascript)");
/**
 ...
 *       log_start_offset => INT64
 *       partition_max_bytes => INT32
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED })=>Object.assign(requestV5({
        replicaId,
        maxWaitTime,
        minBytes,
        maxBytes,
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v6/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v5/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v7/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     topic => STRING
 *     partitions => INT32
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [] })=>({
        apiKey,
        apiVersion: 7,
        apiName: 'Fetch',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v7/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v8/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const ISOLATION_LEVEL = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/isolationLevel.js [app-route] (ecmascript)");
const requestV7 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v7/request.js [app-route] (ecmascript)");
/**
 ...
 *     topic => STRING
 *     partitions => INT32
 */ module.exports = ({ replicaId, maxWaitTime, minBytes, maxBytes, topics, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, sessionId = 0, sessionEpoch = -1, forgottenTopics = [] })=>Object.assign(requestV7({
        replicaId,
        maxWaitTime,
        minBytes,
        maxBytes,
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v8/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/fetch/v9/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/v8/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const COORDINATOR_TYPES = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/coordinatorTypes.js [app-route] (ecmascript)");
const versions = {
    0: ({ groupId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId
            }),
    ...
    1: ({ groupId, coordinatorType = COORDINATOR_TYPES.GROUP })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
    ...
    2: ({ groupId, coordinatorType = COORDINATOR_TYPES.GROUP })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                coordinatorKey: groupId,
                coordinatorType
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { GroupCoordinator: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/request.js [app-route] (ecmascript)");
/**
 * FindCoordinator Request (Version: 2) => coordinator_key coordinator_type
 *   coordinator_key => STRING
 *   coordinator_type => INT8
 */ module.exports = ({ coordinatorKey, coordinatorType })=>Object.assign(requestV1({
        coordinatorKey,
        coordinatorType
    }), {
        apiVersion: 2
...
"[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/v1/response.js [app-route] (ecmascript)");
/**
 * Starting in version 2, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ groupId, groupGenerationId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    1: ({ groupId, groupGenerationId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    2: ({ groupId, groupGenerationId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    3: ({ groupId, groupGenerationId, memberId, groupInstanceId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Heartbeat: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/request.js [app-route] (ecmascript)");
/**
 * Heartbeat Request (Version: 1) => group_id generation_id member_id
 *   group_id => STRING
 *   generation_id => INT32
 *   member_id => STRING
 */ module.exports = ({ groupId, groupGenerationId, memberId })=>Object.assign(requestV0({
        groupId,
        groupGenerationId,
        memberId
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/request.js [app-route] (ecmascript)");
/**
 * Heartbeat Request (Version: 2) => group_id generation_id member_id
 *   group_id => STRING
 *   generation_id => INT32
 *   member_id => STRING
 */ module.exports = ({ groupId, groupGenerationId, memberId })=>Object.assign(requestV1({
        groupId,
        groupGenerationId,
        memberId
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v1/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const apiKeys = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const { KafkaJSServerDoesNotSupportApiKey, KafkaJSNotImplemented } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
/**
 ...
 */ /** @type {RequestDefinitions} */ const noImplementedRequestDefinitions = {
    versions: [],
    protocol: ()=>{
 ...
 */ const requests = {
    Produce: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/index.js [app-route] (ecmascript)"),
    Fetch: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/fetch/index.js [app-route] (ecmascript)"),
    ListOffsets: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/index.js [app-route] (ecmascript)"),
    Metadata: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/index.js [app-route] (ecmascript)"),
    ...
    OffsetCommit: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/index.js [app-route] (ecmascript)"),
    OffsetFetch: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/index.js [app-route] (ecmascript)"),
    GroupCoordinator: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/findCoordinator/index.js [app-route] (ecmascript)"),
    JoinGroup: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/index.js [app-route] (ecmascript)"),
    Heartbeat: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/heartbeat/index.js [app-route] (ecmascript)"),
    LeaveGroup: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/index.js [app-route] (ecmascript)"),
    SyncGroup: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/index.js [app-route] (ecmascript)"),
    DescribeGroups: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeGroups/index.js [app-route] (ecmascript)"),
    ListGroups: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/index.js [app-route] (ecmascript)"),
    SaslHandshake: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/index.js [app-route] (ecmascript)"),
    ApiVersions: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiVersions/index.js [app-route] (ecmascript)"),
    CreateTopics: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createTopics/index.js [app-route] (ecmascript)"),
    DeleteTopics: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteTopics/index.js [app-route] (ecmascript)"),
    DeleteRecords: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteRecords/index.js [app-route] (ecmascript)"),
    InitProducerId: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/index.js [app-route] (ecmascript)"),
    OffsetForLeaderEpoch: noImplementedRequestDefinitions,
    AddPartitionsToTxn: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addPartitionsToTxn/index.js [app-route] (ecmascript)"),
    AddOffsetsToTxn: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/addOffsetsToTxn/index.js [app-route] (ecmascript)"),
    EndTxn: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/endTxn/index.js [app-route] (ecmascript)"),
    WriteTxnMarkers: noImplementedRequestDefinitions,
    TxnOffsetCommit: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/index.js [app-route] (ecmascript)"),
    DescribeAcls: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeAcls/index.js [app-route] (ecmascript)"),
    CreateAcls: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createAcls/index.js [app-route] (ecmascript)"),
    DeleteAcls: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteAcls/index.js [app-route] (ecmascript)"),
    DescribeConfigs: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/describeConfigs/index.js [app-route] (ecmascript)"),
    AlterConfigs: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterConfigs/index.js [app-route] (ecmascript)"),
    AlterReplicaLogDirs: noImplementedRequestDefinitions,
    DescribeLogDirs: noImplementedRequestDefinitions,
    SaslAuthenticate: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/index.js [app-route] (ecmascript)"),
    CreatePartitions: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/createPartitions/index.js [app-route] (ecmascript)"),
    ...
    DeleteGroups: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/deleteGroups/index.js [app-route] (ecmascript)"),
    ElectLeaders: noImplementedRequestDefinitions,
    IncrementalAlterConfigs: noImplementedRequestDefinitions,
    AlterPartitionReassignments: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/index.js [app-route] (ecmascript)"),
    ListPartitionReassignments: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/index.js [app-route] (ecmascript)")
};
...
"[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ transactionalId, transactionTimeout = 5000 })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                transactionTimeout
    ...
    1: ({ transactionalId, transactionTimeout = 5000 })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                transactionTimeout
...
"[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { InitProducerId: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/request.js [app-route] (ecmascript)");
/**
 * InitProducerId Request (Version: 1) => transactional_id transaction_timeout_ms
 *   transactional_id => NULLABLE_STRING
 *   transaction_timeout_ms => INT32
 */ module.exports = ({ transactionalId, transactionTimeout })=>Object.assign(requestV0({
        transactionalId,
        transactionTimeout
    }), {
        apiVersion: 1
...
"[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/initProducerId/v0/response.js [app-route] (ecmascript)");
/**
 * Starting in version 1, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const versions = {
    0: ({ groupId, sessionTimeout, memberId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
    ...
    1: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
    ...
    2: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
    ...
    3: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
    ...
    4: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
    ...
    5: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, groupInstanceId, protocolType, groupProtocols })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v5/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v5/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                sessionTimeout,
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { JoinGroup: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     protocol_name => STRING
 *     protocol_metadata => BYTES
 */ module.exports = ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>({
        apiKey,
        apiVersion: 1,
        apiName: 'JoinGroup',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v1/request.js [app-route] (ecmascript)");
/**
 ...
 *     protocol_name => STRING
 *     protocol_metadata => BYTES
 */ module.exports = ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>Object.assign(requestV1({
        groupId,
        sessionTimeout,
        rebalanceTimeout,
        memberId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/request.js [app-route] (ecmascript)");
/**
 ...
 *     protocol_name => STRING
 *     protocol_metadata => BYTES
 */ module.exports = ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>Object.assign(requestV2({
        groupId,
        sessionTimeout,
        rebalanceTimeout,
        memberId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV2 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV3 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/request.js [app-route] (ecmascript)");
/**
 ...
 *     protocol_name => STRING
 *     protocol_metadata => BYTES
 */ module.exports = ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols })=>Object.assign(requestV3({
        groupId,
        sessionTimeout,
        rebalanceTimeout,
        memberId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v3/response.js [app-route] (ecmascript)");
const { KafkaJSMemberIdRequired } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { failure, createErrorFromCode, errorCodes } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
 ...
 *     member_id => STRING
 *     member_metadata => BYTES
 */ const { code: MEMBER_ID_REQUIRED_ERROR_CODE } = errorCodes.find((e)=>e.type === 'MEMBER_ID_REQUIRED');
const parse = async (data)=>{
    if (failure(data.errorCode)) {
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v5/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     protocol_name => STRING
 *     protocol_metadata => BYTES
 */ module.exports = ({ groupId, sessionTimeout, rebalanceTimeout, memberId, groupInstanceId = null, protocolType, groupProtocols })=>({
        apiKey,
        apiVersion: 5,
        apiName: 'JoinGroup',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/joinGroup/v5/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { KafkaJSMemberIdRequired } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const { failure, createErrorFromCode, errorCodes, failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ groupId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                memberId
    ...
    1: ({ groupId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                memberId
    ...
    2: ({ groupId, memberId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                memberId
    ...
    3: ({ groupId, memberId, groupInstanceId })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                members: [
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { LeaveGroup: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/request.js [app-route] (ecmascript)");
/**
 * LeaveGroup Request (Version: 1) => group_id member_id
 *   group_id => STRING
 *   member_id => STRING
 */ module.exports = ({ groupId, memberId })=>Object.assign(requestV0({
        groupId,
        memberId
    }), {
        apiVersion: 1
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/request.js [app-route] (ecmascript)");
/**
 * LeaveGroup Request (Version: 2) => group_id member_id
 *   group_id => STRING
 *   member_id => STRING
 */ module.exports = ({ groupId, memberId })=>Object.assign(requestV1({
        groupId,
        memberId
    }), {
        apiVersion: 2
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v1/response.js [app-route] (ecmascript)");
/**
 * In version 2 on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported, failure, createErrorFromCode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV2 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/leaveGroup/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response
        };
    ...
    1: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response
        };
    ...
    2: ()=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v2/response.js [app-route] (ecmascript)");
        return {
            request: request(),
            response
        };
...
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { ListGroups: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/request.js [app-route] (ecmascript)");
/**
 * ListGroups Request (Version: 1)
 */ module.exports = ()=>Object.assign(requestV0(), {
        apiVersion: 1
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const responseV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v0/response.js [app-route] (ecmascript)");
const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/request.js [app-route] (ecmascript)");
/**
 * ListGroups Request (Version: 2)
 */ module.exports = ()=>Object.assign(requestV1(), {
        apiVersion: 2
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listGroups/v1/response.js [app-route] (ecmascript)");
/**
 * In version 2 on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const versions = {
    0: ({ replicaId = REPLICA_ID, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                topics
    ...
    1: ({ replicaId = REPLICA_ID, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                topics
    ...
    2: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
    ...
    3: ({ replicaId = REPLICA_ID, isolationLevel = ISOLATION_LEVEL.READ_COMMITTED, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                replicaId,
                isolationLevel,
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { ListOffsets: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/request.js [app-route] (ecmascript)");
/**
 ...
 *       partition => INT32
 *       timestamp => INT64
 */ module.exports = ({ replicaId, isolationLevel, topics })=>Object.assign(requestV2({
        replicaId,
        isolationLevel,
        topics
    }), {
...
"[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV2 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listOffsets/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics, timeout })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                timeout
...
"[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { ListPartitionReassignments: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/listPartitionReassignments/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics
            }),
    ...
    1: ({ topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics
            }),
    ...
    2: ({ topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics
            }),
    ...
    3: ({ topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics
            }),
    ...
    4: ({ topics, allowAutoTopicCreation })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                allowAutoTopicCreation
    ...
    5: ({ topics, allowAutoTopicCreation })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                allowAutoTopicCreation
    ...
    6: ({ topics, allowAutoTopicCreation })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v6/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v6/response.js [app-route] (ecmascript)");
        return {
            request: request({
                topics,
                allowAutoTopicCreation
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Metadata: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v1/request.js [app-route] (ecmascript)");
/**
 * Metadata Request (Version: 2) => [topics]
 *   topics => STRING
 */ module.exports = ({ topics })=>Object.assign(requestV1({
        topics
    }), {
        apiVersion: 2
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse: parseV3, decode: decodeV3 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v3/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV4 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v4/request.js [app-route] (ecmascript)");
/**
 * Metadata Request (Version: 5) => [topics] allow_auto_topic_creation
 *   topics => STRING
 *   allow_auto_topic_creation => BOOLEAN
 */ module.exports = ({ topics, allowAutoTopicCreation = true })=>Object.assign(requestV4({
        topics,
        allowAutoTopicCreation
    }), {
        apiVersion: 5
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v6/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV5 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/request.js [app-route] (ecmascript)");
/**
 * Metadata Request (Version: 6) => [topics] allow_auto_topic_creation
 *   topics => STRING
 *   allow_auto_topic_creation => BOOLEAN
 */ module.exports = ({ topics, allowAutoTopicCreation = true })=>Object.assign(requestV5({
        topics,
        allowAutoTopicCreation
    }), {
        apiVersion: 6
...
"[project]/node_modules/kafkajs/src/protocol/requests/metadata/v6/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/metadata/v5/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

// This value signals to the broker that its default configuration should be used.
const RETENTION_TIME = -1;
const versions = {
    0: ({ groupId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                topics
    ...
    1: ({ groupId, groupGenerationId, memberId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    2: ({ groupId, groupGenerationId, memberId, retentionTime = RETENTION_TIME, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    3: ({ groupId, groupGenerationId, memberId, retentionTime = RETENTION_TIME, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    4: ({ groupId, groupGenerationId, memberId, retentionTime = RETENTION_TIME, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
    ...
    5: ({ groupId, groupGenerationId, memberId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v5/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v5/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                groupGenerationId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { OffsetCommit: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV2 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v2/request.js [app-route] (ecmascript)");
/**
 ...
 *       offset => INT64
 *       metadata => NULLABLE_STRING
 */ module.exports = ({ groupId, groupGenerationId, memberId, retentionTime, topics })=>Object.assign(requestV2({
        groupId,
        groupGenerationId,
        memberId,
        retentionTime,
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV3 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/request.js [app-route] (ecmascript)");
/**
 ...
 *       offset => INT64
 *       metadata => NULLABLE_STRING
 */ module.exports = ({ groupId, groupGenerationId, memberId, retentionTime, topics })=>Object.assign(requestV3({
        groupId,
        groupGenerationId,
        memberId,
        retentionTime,
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV3 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v3/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v5/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v5/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetCommit/v4/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    1: ({ groupId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                topics
    ...
    2: ({ groupId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                topics
    ...
    3: ({ groupId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                topics
    ...
    4: ({ groupId, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                topics
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { OffsetFetch: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v1/request.js [app-route] (ecmascript)");
/**
 ...
 *     partitions => partition
 *       partition => INT32
 */ module.exports = ({ groupId, topics })=>Object.assign(requestV1({
        groupId,
        topics
    }), {
        apiVersion: 2
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV2 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v2/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV3 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/request.js [app-route] (ecmascript)");
/**
 ...
 *     partitions => partition
 *       partition => INT32
 */ module.exports = ({ groupId, topics })=>Object.assign(requestV3({
        groupId,
        topics
    }), {
        apiVersion: 4
...
"[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV3 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/offsetFetch/v3/response.js [app-route] (ecmascript)");
/**
 * Starting in version 4, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ acks, timeout, topicData })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    1: ({ acks, timeout, topicData })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    2: ({ acks, timeout, topicData, compression })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    3: ({ acks, timeout, compression, topicData, transactionalId, producerId, producerEpoch })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    4: ({ acks, timeout, compression, topicData, transactionalId, producerId, producerEpoch })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v4/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v4/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    5: ({ acks, timeout, compression, topicData, transactionalId, producerId, producerEpoch })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    6: ({ acks, timeout, compression, topicData, transactionalId, producerId, producerEpoch })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
    ...
    7: ({ acks, timeout, compression, topicData, transactionalId, producerId, producerEpoch })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v7/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v7/response.js [app-route] (ecmascript)");
        return {
            request: request({
                acks,
                timeout,
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Produce: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const MessageSet = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/messageSet/index.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/request.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Produce: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const MessageSet = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/messageSet/index.js [app-route] (ecmascript)");
const { Types, lookupCodec } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Long = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)");
const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { Produce: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
const { Types } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/message/compression/index.js [app-route] (ecmascript)");
const Record = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/record/v0/index.js [app-route] (ecmascript)");
const { RecordBatch } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/recordBatch/v0/index.js [app-route] (ecmascript)");
/**
 ...
 * @param topicData {Array}
 */ module.exports = ({ acks, timeout, transactionalId = null, producerId = Long.fromInt(-1), producerEpoch = 0, compression = Types.None, topicData })=>({
        apiKey,
        apiVersion: 3,
        apiName: 'Produce',
        expectResponse: ()=>acks !== 0,
        encode: async ()=>{
            ...
            const encodedTopicData = [];
            for (const data of topicData){
                encodedTopicData.push(await encodeTopic({
                    ...data,
                    transactionalId,
                    producerId,
                    producerEpoch
...
const topicEncoder = (compression)=>async ({ topic, partitions, transactionalId, producerId, producerEpoch })=>{
        const encodePartitions = partitionsEncoder(compression);
        const encodedPartitions = [];
        for (const data of partitions){
            encodedPartitions.push(await encodePartitions({
                ...data,
                transactionalId,
                producerId,
                producerEpoch
...
const partitionsEncoder = (compression)=>async ({ partition, messages, transactionalId, firstSequence, producerId, producerEpoch })=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v4/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV3 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/request.js [app-route] (ecmascript)");
/**
 ...
 *       partition => INT32
 *       record_set => RECORDS
 */ module.exports = ({ acks, timeout, transactionalId, producerId, producerEpoch, compression, topicData })=>Object.assign(requestV3({
        acks,
        timeout,
        transactionalId,
        producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v4/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { parse: parseV3 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v3/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV5 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/request.js [app-route] (ecmascript)");
/**
 ...
 *       partition => INT32
 *       record_set => RECORDS
 */ module.exports = ({ acks, timeout, transactionalId, producerId, producerEpoch, compression, topicData })=>Object.assign(requestV5({
        acks,
        timeout,
        transactionalId,
        producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV5 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v5/response.js [app-route] (ecmascript)");
/**
 * The version number is bumped to indicate that on quota violation brokers send out responses before throttling.
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v7/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV6 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/request.js [app-route] (ecmascript)");
/**
 ...
 *       partition => INT32
 *       record_set => RECORDS
 */ module.exports = ({ acks, timeout, transactionalId, producerId, producerEpoch, compression, topicData })=>Object.assign(requestV6({
        acks,
        timeout,
        transactionalId,
        producerId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/produce/v7/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/produce/v6/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ authBytes })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                authBytes
            }),
    ...
    1: ({ authBytes })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                authBytes
            }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { SaslAuthenticate: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { failure, createErrorFromCode, failIfVersionNotSupported, errorCodes } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { KafkaJSProtocolError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/request.js [app-route] (ecmascript)");
/**
 * SaslAuthenticate Request (Version: 1) => sasl_auth_bytes
 *   sasl_auth_bytes => BYTES
 */ /**
 * @param {Buffer} authBytes - SASL authentication bytes from client as defined by the SASL mechanism
 */ module.exports = ({ authBytes })=>Object.assign(requestV0({
        authBytes
    }), {
        apiVersion: 1
    });
}),
"[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslAuthenticate/v0/response.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ mechanism })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                mechanism
            }),
    ...
    1: ({ mechanism })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                mechanism
            }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { SaslHandshake: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/request.js [app-route] (ecmascript)");
module.exports = ({ mechanism })=>({
        ...requestV0({
            mechanism
        }),
...
"[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode: decodeV0, parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/saslHandshake/v0/response.js [app-route] (ecmascript)");
module.exports = {
    decode: decodeV0,
    parse: parseV0
};
}),
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ groupId, generationId, memberId, groupAssignment })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                generationId,
    ...
    1: ({ groupId, generationId, memberId, groupAssignment })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                generationId,
    ...
    2: ({ groupId, generationId, memberId, groupAssignment })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v2/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v2/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                generationId,
    ...
    3: ({ groupId, generationId, memberId, groupInstanceId, groupAssignment })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v3/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v3/response.js [app-route] (ecmascript)");
        return {
            request: request({
                groupId,
                generationId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { SyncGroup: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/request.js [app-route] (ecmascript)");
/**
 ...
 *     member_id => STRING
 *     member_assignment => BYTES
 */ module.exports = ({ groupId, generationId, memberId, groupAssignment })=>Object.assign(requestV0({
        groupId,
        generationId,
        memberId,
        groupAssignment
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
const { failIfVersionNotSupported } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/error.js [app-route] (ecmascript)");
const { parse: parseV0 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v2/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV1 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/request.js [app-route] (ecmascript)");
/**
 ...
 *     member_id => STRING
 *     member_assignment => BYTES
 */ module.exports = ({ groupId, generationId, memberId, groupAssignment })=>Object.assign(requestV1({
        groupId,
        generationId,
        memberId,
        groupAssignment
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v2/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v1/response.js [app-route] (ecmascript)");
/**
 * In version 2, on quota violation, brokers send out responses before throttling.
 * @see https://cwiki.apache.org/confluence/display/KAFKA/KIP-219+-+Improve+quota+communication
 *
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v3/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 *     member_id => STRING
 *     member_assignment => BYTES
 */ module.exports = ({ groupId, generationId, memberId, groupInstanceId = null, groupAssignment })=>({
        apiKey,
        apiVersion: 3,
        apiName: 'SyncGroup',
        encode: async ()=>{
...
"[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v3/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { decode, parse } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/syncGroup/v2/response.js [app-route] (ecmascript)");
/**
 * SyncGroup Response (Version: 2) => throttle_time_ms error_code member_assignment
 *   throttle_time_ms => INT32
 *   error_code => INT16
...
"[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const versions = {
    0: ({ transactionalId, groupId, producerId, producerEpoch, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                groupId,
    ...
    1: ({ transactionalId, groupId, producerId, producerEpoch, topics })=>{
        const request = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v1/request.js [app-route] (ecmascript)");
        const response = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v1/response.js [app-route] (ecmascript)");
        return {
            request: request({
                transactionalId,
                groupId,
...
"[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const Encoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/encoder.js [app-route] (ecmascript)");
const { TxnOffsetCommit: apiKey } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/apiKeys.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v1/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const requestV0 = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/request.js [app-route] (ecmascript)");
/**
 ...
 *       offset => INT64
 *       metadata => NULLABLE_STRING
 */ module.exports = ({ transactionalId, groupId, producerId, producerEpoch, topics })=>Object.assign(requestV0({
        transactionalId,
        groupId,
        producerId,
        producerEpoch,
...
"[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v1/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { parse, decode: decodeV1 } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/requests/txnOffsetCommit/v0/response.js [app-route] (ecmascript)");
/**
...
"[project]/node_modules/kafkajs/src/protocol/resourcePatternTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    request: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/request.js [app-route] (ecmascript)"),
    response: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/response.js [app-route] (ecmascript)")
};
}),
"[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/awsIam/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    request: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/request.js [app-route] (ecmascript)"),
    response: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/response.js [app-route] (ecmascript)")
};
}),
"[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/oauthBearer/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/plain/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    request: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/plain/request.js [app-route] (ecmascript)"),
    response: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/plain/response.js [app-route] (ecmascript)")
};
}),
"[project]/node_modules/kafkajs/src/protocol/sasl/plain/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/plain/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/scram/finalMessage/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/scram/finalMessage/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/firstMessage/response.js [app-route] (ecmascript)");
}),
"[project]/node_modules/kafkajs/src/protocol/sasl/scram/firstMessage/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/protocol/sasl/scram/firstMessage/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/* eslint no-unused-vars: ["error", { "varsIgnorePattern": "_" }] */ const Decoder = __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/decoder.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/protocol/sasl/scram/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    firstMessage: {
        request: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/firstMessage/request.js [app-route] (ecmascript)"),
        response: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/firstMessage/response.js [app-route] (ecmascript)")
    },
    finalMessage: {
        request: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/finalMessage/request.js [app-route] (ecmascript)"),
        response: __turbopack_context__.r("[project]/node_modules/kafkajs/src/protocol/sasl/scram/finalMessage/response.js [app-route] (ecmascript)")
    }
};
}),
"[project]/node_modules/kafkajs/src/protocol/timestampTypes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/retry/defaults.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/retry/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { KafkaJSNumberOfRetriesExceeded, KafkaJSNonRetriableError } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const isTestMode = ("TURBOPACK compile-time value", "development") === 'test';
const RETRY_DEFAULT = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : __turbopack_context__.r("[project]/node_modules/kafkajs/src/retry/defaults.js [app-route] (ecmascript)");
...
"[project]/node_modules/kafkajs/src/utils/arrayDiff.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/groupBy.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/lock.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { format } = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
const { KafkaJSLockTimeout } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
const PRIVATE = {
...
"[project]/node_modules/kafkajs/src/utils/long.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/once.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/seq.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/**
 * @param {number} count
 * @param {(index: number) => T} [callback]
 * @template T
 */ const seq = (count, callback = (x)=>x)=>new Array(count).fill(0).map((_, index)=>callback(index));
module.exports = seq;
}),
"[project]/node_modules/kafkajs/src/utils/sharedPromiseTo.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/shuffle.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/kafkajs/src/utils/sleep.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = (timeInMs)=>new Promise((resolve)=>{
        setTimeout(resolve, timeInMs);
    });
}),
"[project]/node_modules/kafkajs/src/utils/swapObject.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { keys } = Object;
module.exports = (object)=>keys(object).reduce((result, key)=>({
            ...result,
            [object[key]]: key
        }), {});
}),
"[project]/node_modules/kafkajs/src/utils/waitFor.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const sleep = __turbopack_context__.r("[project]/node_modules/kafkajs/src/utils/sleep.js [app-route] (ecmascript)");
const { KafkaJSTimeout } = __turbopack_context__.r("[project]/node_modules/kafkajs/src/errors.js [app-route] (ecmascript)");
module.exports = (fn, { delay = 50, maxWait = 10000, timeoutMessage = 'Timeout', ignoreTimeout = false } = {})=>{
    let timeoutId;
    let totalWait = 0;
    let fulfilled = false;
...
"[project]/node_modules/kafkajs/src/utils/websiteUrl.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=node_modules_kafkajs_0q-8lr4._.js.map